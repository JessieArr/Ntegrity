...
namespace Ntegrity.Test
{
    ...
    public class PropertyDiffTests
    {
        ...
        public void HasChanged_IsSet_ForChangedField()
        {
            ...
            var oldField = new Mock<IPropertyData>();
            ...
            var newField = new Mock<IPropertyData>();
            ...
            var SUT = new PropertyDiff(oldField.Object, newField.Object);
        ...
        {
            var oldFieldName = "Test.OldProperty";
            var oldField = new Mock<IPropertyData>();
            oldField.SetupGet(x => x.PropertySignature)
                .Returns(oldFieldName);

            var newFieldName = "Test.NewProperty";
            var newField = new Mock<IPropertyData>();
            newField.SetupGet(x => x.PropertySignature)
